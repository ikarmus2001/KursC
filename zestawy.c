...
//
//void zamien(double *first, double *second)  // sprawdzić później
//{
//	double* tmp = *first;
//	first = second;
//	*second = tmp;
...
//            if (buffer[i] == ' '){
//                if (biezacy == NULL){
//                    biezacy = (Wezel*)malloc(sizeof(Wezel));
//                    biezacy->wartosc = tmp;
//                    tmp = 0;
//                    *pierwszy = biezacy;
//                }
//                else{
//                    biezacy->nastepny = (Wezel*)malloc(sizeof(Wezel));
//                    biezacy = biezacy->nastepny;
//                    biezacy->wartosc = tmp;
//                    tmp = 0;
//                }
...
//            }
//            else
//                tmp = 10 * tmp + (buffer[i] - '0');
//        }
//    }
//    biezacy->nastepny = *pierwszy;
//}
//
//// przyjmuje jako argument adres jednego z elementów listy,
//// zwraca w wyniku jej rozmiar 
//// (funkcja ma zwrócić zawsze ten sam rozmiar, bez względu na to,
//// od którego elementu zaczynamy liczyć).
//int rozmiarListy(Wezel* node){
//    if (!node) {
//        return 0;
//    }
//    int rozmiar = 1;  // wliczając pierwszy węzeł
//    Wezel* biezacy = node->nastepny;
//    while (biezacy->nastepny != node) {
//        biezacy = biezacy->nastepny;
//        rozmiar++;
//    }
//    return rozmiar + 1; // wliczając węzeł ostatni
//}
//
//int main(void){
